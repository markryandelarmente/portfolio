...
export default function Home() {
  ...
  const portfolio = [
    ...
    },
    {
      ...
      github: "",
      bannerImage: "/portfolio/project.webp",
      description: "A starter kit for full-stack developers to build web applications quickly with pre-built components and features.",
      technologies: [
        { name: "Next.js", logo: "/skills/next.js.png" },
        { name: "Tailwind CSS", logo: "/skills/tailwind.css.png" },
        { name: "TypeScript", logo: "/skills/typescript.png" },
    ...
    <div className="flex min-h-screen justify-center font-sans px-4">
      <main className="mx-auto max-w-4xl w-full">
        ...
        <section className="py-10 lg:py-16 border-[#18264f] lg:border-b">
          ...
          <p className="text-secondary-foreground text-sm mt-2">These are some of the projects I’ve worked on in my career. Others are not listed due to company policies.</p>
        ...
        <section className="py-10 lg:py-16 text-center">
          ...
          <div className="mt-16 flex text-center justify-center gap-x-10">
            <a href="https://github.com/markryandelarmente" target="_blank" rel="noopener noreferrer">
              Github <ExternalLinkIcon className="w-4 h-4 inline-block ml-2" />
            </a>
            <a href="https://www.linkedin.com/in/mark-ryan-delarmente" target="_blank" rel="noopener noreferrer">
              LinkedIn <ExternalLinkIcon className="w-4 h-4 inline-block ml-2" />
            </a>
            <a href="https://www.linkedin.com/in/mark-ryan-delarmente" target="_blank" rel="noopener noreferrer">
              Twitter <ExternalLinkIcon className="w-4 h-4 inline-block ml-2" />
            </a>
          </div>
        </section>
      </main>
